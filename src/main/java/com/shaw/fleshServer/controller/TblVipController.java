...
public class TblVipController {
    ...
    public FleshResult isPaySuccess(@RequestParam String deviceId, @RequestParam String paymentId) {
        boolean result = tblVipService.isPaySuccess(deviceId, paymentId);
